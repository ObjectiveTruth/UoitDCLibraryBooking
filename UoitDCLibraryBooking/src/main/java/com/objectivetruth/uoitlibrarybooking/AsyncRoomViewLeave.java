...
public class AsyncRoomViewLeave extends AsyncTask<String[], int[], String> {
	...
	protected void onPreExecute() {
        ...
        progDialog.setMessage("Leaving a Reservation");
        ...
        progDialog.setOnCancelListener(new OnCancelListener(){
			...
			public void onCancel(DialogInterface diag) {
				if(mAsyncRoomViewLeave.cancel(true)){
	...
	protected String doInBackground(String[]... input) {
            ...
            try{
				...
				String ButtonLeaveGroup = inputData[4];
		        ...
		        String content = "__VIEWSTATE=" + URLEncoder.encode(viewState, "UTF-8")
		        		...
		        		+ "&ctl00$ContentPlaceHolder1$TextBoxStudentID=" + TextBoxID
		             	+ "&ctl00$ContentPlaceHolder1$ButtonLeaveGroup=" + ButtonLeaveGroup;
